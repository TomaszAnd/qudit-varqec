#!/usr/bin/env python3
"""Train VarQEC dephasing code, distance 2 (1 layer). ~5 min."""
import argparse
import warnings
...
def main():
    parser = argparse.ArgumentParser(description="Train dephasing d=2 code")
    ...
    print(f"Training: dephasing d={DISTANCE}, {N_LAYERS} layer, seed={args.seed}, {args.n_steps} steps")
    t0 = time.time()
